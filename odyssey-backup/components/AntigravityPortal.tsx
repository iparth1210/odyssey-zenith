      ...
      >
        ...
        <div className="relative z-10 text-center space-y-8 animate-float">
          ...
          <div className="space-y-2">
            <h1 className="text-7xl font-black text-white tracking-tighter">ODYSSEY<span className="text-indigo-500">.</span>CORE</h1>
            <p className="text-slate-500 text-sm font-black uppercase tracking-[0.5em]">Antigravity Protocol Active</p>
          </div>
        </div>
        ...
        >
          ...
          <p className="text-slate-500 text-xs font-bold mt-4">Current Phase: Month {activeModule.month}</p>
        </div>
